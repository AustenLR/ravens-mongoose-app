...
var userSchema = new mongoose.Schema({
  email: {
    type: String,
    lowercase: true, //makes it so everything in the database is stored in lowercase; dont get error for typing email with capital letters
    required: true
  },
  password: {
    type: String,
...
userSchema.pre('save', function(next) { //pre is a method on the user schema; before you save the document, run the callback ; and next is a callback as we see in line 27; its called next because its the next step 
